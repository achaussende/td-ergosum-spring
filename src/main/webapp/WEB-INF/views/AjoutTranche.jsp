            ...
            <form class="form-horizontal" action="/addTranche.htm" method="post" id="form1">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="tranche" name="tranche" type="number" placeholder="nom" class="form-control"
                                   value="${tranche.codetranche}" required="">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="agemin" name="agemin" type="number" placeholder="age" min="0" max="99"
                                   class="form-control" value="${tranche.agemin}" required="">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="agemax" name="agemax" type="number" placeholder="age" min="0" max="99"
                                   class="form-control" value="${tranche.agemax}" required="">
                        </div>
                    </div>
                </fieldset>
                <br>
